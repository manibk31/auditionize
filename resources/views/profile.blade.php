  ...
  <div id="cover">
    ...
    <i class="fa fa-envelope fa-2" style="color:#e0dcdc;cursor:pointer" aria-hidden="true"  > </i><span style="color:#e0dcdc;cursor:pointer;"><a> Message</a></span>
      ...
      <div  class="col-xs-2"  style="margin-top:10px; margin-left:3px; color:#e0dcdc;"  data-toggle="modal" data-target="#followers" >
    <span style="color:#e0dcdc;cursor:pointer;"> 0 <a>Followers</a></span>
      </div>
      <div  class="col-xs-2"  style="margin-top:10px; margin-left:3px; color:#e0dcdc; "  data-toggle="modal" data-target="#following">
            ...
            <div class="modal-content">
              <div class="modal-body">
                ...
                <iframe width="100%" height="350" src="" frameborder="0" allowfullscreen></iframe>
                  ...
                  <div class="videodesc graytext centered padding-15">
                    <div class="row"><h4>Description</h4></div>
                    <div class="row">

                       <p>The description of video goes here. ALl the stuff thats been done by the person goes here</p>
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Message Abhinandh</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="followers" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row center-align">
              <i class="row fa fa-user fa-lg"  aria-hidden="true"></i>
              <div class="row">
                <p class="graytext">
                  No Followers
                </p>
